...
// creating volume as file system

// creating aws efs system
...
resource "aws_efs_mount_target" "efs-attach" {
...
inline= [ 
      ...
      "sudo git clone https://github.com/iamvikasdevops/AWS-Terraform-TASK2REPO.git /var/www/html/"
         ]
...
resource "aws_s3_bucket_object" "bucket-object" {
  ...
  source     = "C:/Users/vikas/Desktop/Task02display.png"
  acl        = "public-read"
}
